...
from layers.Transformer_EncDec_GPT import Decoder, DecoderLayer, Encoder, EncoderLayer, ConvLayer
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        or self.task_name == 'forecastImputation_GPT':
    ...
    #     dec_out = self.decoder(dec_out, x_mask=None, tau=tau, delta=delta)
    ...
    def forecast(self, x_enc, x_mark_enc, a=None, b=None):
        # Normalization
        ...
        dec_enc = self.dec_embedding(x_enc, x_mark_enc)
        dec_out = self.decoder(dec_enc, x_mask=None)
