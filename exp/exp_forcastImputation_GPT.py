...
class Exp_ForecastImputation_GPT(Exp_Basic):
    def __init__(self, args):
        super(Exp_ForecastImputation_GPT, self).__init__(args)
    ...
    def test(self, setting, test=0):
        ...
        f = open("result_forecastImputation_GPT.txt", 'a')
        f.write(setting + "  \n")
