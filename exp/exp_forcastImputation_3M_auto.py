...
class Exp_ForecastImputation_3M_auto(Exp_Basic):
    def __init__(self, args):
        super(Exp_ForecastImputation_3M_auto, self).__init__(args)
    ...
    def vali(self, vali_data, vali_loader, criterion):
        ...
        with torch.no_grad():
            ...
            for i in range(0, len(data_impute), seq_len):
                ...
                outputs, impute_ratio = self.model_impute(inp, inp_mark, None, None, mask)
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            for i, (batch_x, batch_x_mark, batch_y, batch_y_mark, batch_z, batch_z_mark) in enumerate(train_loader):
                ...
                mask_rate = random.uniform(0.01, 0.9)
                ...
                outputs_impute, impute_ratio = self.model_impute(inp, batch_y_mark, None, None, mask)
